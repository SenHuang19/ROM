...
x=zip(tab['tout'][1:],tab['s'][1:],tab['i'][1:],tab['t1'][:-1],tab['w1'][1:],tab['w2'][1:],tab['w3'][1:],tab['hsp'][1:],tab['csp0'][1:],tab['csp1'][1:],tab['csp2'][1:],tab['csp3'][1:],tab['csp4'][1:],tab['m0'][1:],tab['m1'][1:],tab['m2'][1:],tab['m3'][1:],tab['m4'][1:],tab['rh0'][1:],tab['rh1'][1:],tab['rh2'][1:],tab['rh3'][1:],tab['rh4'][1:]) 
y=tab['t1'][1:]
regr.fit(x, y)
...
for i in range(len(tab)-1):
    x=zip(tab['tout'][i+1:i+2],tab['s'][i+1:i+2],tab['i'][i+1:i+2],t,tab['w1'][i+1:i+2],tab['w2'][i+1:i+2],tab['w3'][i+1:i+2],tab['hsp'][1:],tab['csp0'][i+1:i+2],tab['csp1'][i+1:i+2],tab['csp2'][i+1:i+2],tab['csp3'][i+1:i+2],tab['csp4'][i+1:i+2],tab['m0'][i+1:i+2],tab['m1'][i+1:i+2],tab['m2'][i+1:i+2],tab['m3'][i+1:i+2],tab['m4'][i+1:i+2],tab['rh0'][1:],tab['rh1'][i+1:i+2],tab['rh2'][i+1:i+2],tab['rh3'][i+1:i+2],tab['rh4'][i+1:i+2]) 
