...
x=zip(tab['tout'][1:],tab['i'][1:],tab['t1'][:-1],tab['hsp'][1:],tab['csp0'][1:],tab['w1'][1:],tab['w2'][1:],tab['t2'][1:]) 
y=tab['t1'][1:]
regr.fit(x, y)
...
for i in range(len(tab)-1):
    ...
    x=zip(tab['tout'][i+1:i+2],tab['i'][i+1:i+2],t,tab['hsp'][1:],tab['csp0'][i+1:i+2],tab['w1'][i+1:i+2],tab['w2'][i+1:i+2],tab['t2'][i+1:i+2]) 
