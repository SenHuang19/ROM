...
for i in range(len(zones)):
    ...
    zmdm.append('TOPFLOOR_PLENUM OUTLET NODE:System Node Mass Flow Rate [kg/s](TimeStep)')
    zmdt.append('TOPFLOOR_PLENUM OUTLET NODE:System Node Temperature [C](TimeStep)')
...
for i in range(len(zones)):
    name='m'+str(i)
    tab2[name]=tab['TOPFLOOR_PLENUM OUTLET NODE:System Node Mass Flow Rate [kg/s](TimeStep)']
    #name='rh'+str(i)
