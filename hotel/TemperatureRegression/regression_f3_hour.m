...
for ii=1:N-1
    ...
    for hh=1:24
        ...
        coef(:,hh,ii)=quadprog(input_train'*input_train, -output_train'*input_train, -eye(4),-1e-4*ones(4,1));
    end
...
for hh=1:24
    ...
    input_train=[Tout-Tzone1_input_train Qint_train+Qrh_train m_train Tzone1_input_train];
    output_train=Tzone1_output_train;
    coef(:,hh,N)=quadprog(input_train'*input_train, -output_train'*input_train, -eye(4),-1e-4*ones(4,1));
end
%%
